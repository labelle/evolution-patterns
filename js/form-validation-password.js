...
// show or hide password with eye-book-gray.svg in box field
function toggle_password_eye_box(target){
    var d = document;
    var tag = d.getElementById(target);
    var tag3 = d.getElementById("showhidegrayeyebox");

    if (tag3.innerHTML == '<img src="https://labelle.github.io/evolution-patterns/icons-gray/book-gray/eye-slash-book-gray.svg" id="input_img_box">'){
        tag.setAttribute('type', 'text');   
        tag3.innerHTML = '<img src="https://labelle.github.io/evolution-patterns/icons-gray/book-gray/eye-book-gray.svg" id="input_img_box">';

    } else {
        tag.setAttribute('type', 'password');   
        tag3.innerHTML = '<img src="https://labelle.github.io/evolution-patterns/icons-gray/book-gray/eye-slash-book-gray.svg" id="input_img_box">';
    }
